...
func mapDeploymentUrl(v1 fiber.Router) {
	// chainlink group
	chainlinkGroup := v1.Group("chainlink", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	...
	//ethereum group
	ethereumGroup := v1.Group("ethereum", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	...
	//core group
	coreGroup := v1.Group("core", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	//secret group
	...
	//storage class group
	storageClasses := coreGroup.Group("storageclasses", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	...
	//validators group
	validatorsGroup := ethereum2.Group("validators", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	...
	//filecoin group
	filecoinGroup := v1.Group("filecoin", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	...
	//ipfs group
	ipfsGroup := v1.Group("ipfs", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	//ipfs peer group
	...
	//ipfs peer group
	clusterpeersGroup := ipfsGroup.Group("clusterpeers", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	...
	//near group
	nearGroup := v1.Group("near", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
	...
	polkadotGroup := v1.Group("polkadot", middleware.JWTProtected, middleware.TFAProtected, middleware.DeploymentsWorkspaceProtected)
