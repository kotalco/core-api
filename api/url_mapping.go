...
func MapUrl(app *fiber.App) {
	...
	workspaces.Get("/:id", middleware.IsWorkspace, middleware.WorkspaceProtected, middleware.IsReader, workspace.GetById)
...
func mapDeploymentUrl(v1 fiber.Router) {
	// chainlink group
	chainlinkGroup := v1.Group("chainlink", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	...
	//ethereum group
	ethereumGroup := v1.Group("ethereum", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	...
	//core group
	coreGroup := v1.Group("core", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	//secret group
	...
	//storage class group
	storageClasses := coreGroup.Group("storageclasses", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	...
	//ethereum2 group
	ethereum2 := v1.Group("ethereum2", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	//beaconnodes group
	...
	//validators group
	validatorsGroup := ethereum2.Group("validators", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	...
	//filecoin group
	filecoinGroup := v1.Group("filecoin", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	...
	//ipfs group
	ipfsGroup := v1.Group("ipfs", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	//ipfs peer group
	...
	//ipfs peer group
	clusterpeersGroup := ipfsGroup.Group("clusterpeers", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	...
	//near group
	nearGroup := v1.Group("near", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
	...
	polkadotGroup := v1.Group("polkadot", middleware.JWTProtected, middleware.TFAProtected, middleware.WorkspaceProtected)
